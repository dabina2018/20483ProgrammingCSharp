    ...
    public partial class MainWindow : Window
    {
        ...
        private void saveChanges_Click(object sender, RoutedEventArgs e)
        {
            ...
            try
            {
                ...
                //Disable the Save button (it will be enabled ifthe user makes more changes)
            ...
            {
                //If the user has changeed the same students earlier, then overwrite thier changes with the new data
            ...
            catch (UpdateException uEx)
            {
                ...
                MessageBox.Show(uEx.InnerException.Message, "Error saving change");
                this.schoolContext.Refresh(RefreshMode.StoreWins, schoolContext.Students);
            }
